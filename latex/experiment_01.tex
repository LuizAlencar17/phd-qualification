...
This chapter presents the first main contribution of the thesis, focused on evaluating the use of multimodal artificial intelligence models to support key stages of the camera-trap workflow in biodiversity monitoring. The study examines the application of CLIP, BLIP, GPT-4o, and Gemini 2.0 flash-exp to three tasks: empty-image filtering, species classification, and behavior identification. It describes the datasets, experimental protocols, evaluation metrics, and results, with emphasis on the comparison between zero-shot and few-shot settings and, for behavior analysis, between single-image and sequence-based inference. An initial version of this study was published in \citep{alencar2024zero}, while the complete version was published in \citep{alencar2026advancing}.
...
\begin{figure*}[!ht]
\centering
\includegraphics[width=6in]{images/experiment_01/experiment_1-example_animal.png}
...
In species classification, BLIP again performed very poorly in zero-shot mode, with accuracy of 0.0006, recall of 0.0005, and F1-score of 0.0011. In contrast, BLIP-FewShot reached accuracy of 0.7524 and F1-score of 0.7556. These results indicate a strong dependence of BLIP on few-shot adaptation for this task (Figure ~\ref{fig:experiment_1-example_species}).
...
The species-wise recall values are reported in Table~\ref{tab:species_recall}.
...
\begin{figure*}[!ht]
\centering
\includegraphics[width=6in]{images/experiment_01/experiment_1-example_species.png}
\caption{Examples of correct species identification: (a) Only CLIP-FewShot correctly identified a gazelle; (b) Only GPT correctly identified a gazelle; (c) Only BLIP-FewShot correctly identified a lion (the bounding box in the image is just to help see where the animal is, due to the conditions of some images).}
...
\begin{figure*}[!ht]
\centering
\includegraphics[width=3in]{images/experiment_01/experiment_1-example_seq.png}
